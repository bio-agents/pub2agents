...
public class Suggestion2 extends Suggestion1 {
	...
	private Set<BioagentsLink<LinkType>> linkLinks = new LinkedHashSet<>();

	private Set<BioagentsLink<DownloadType>> downloadLinks = new LinkedHashSet<>();

	private Set<BioagentsLink<DocumentationType>> documentationLinks = new LinkedHashSet<>();

	private Set<BioagentsLink<?>> brokenLinks = new LinkedHashSet<>();
	...
	public Set<BioagentsLink<LinkType>> getLinkLinks() {
		return linkLinks;
	}
	public void addLinkLinks(List<BioagentsLink<LinkType>> linkLinks) {
		this.linkLinks.addAll(linkLinks);
	}

	public Set<BioagentsLink<DownloadType>> getDownloadLinks() {
		return downloadLinks;
	}
	public void addDownloadLinks(List<BioagentsLink<DownloadType>> downloadLinks) {
		this.downloadLinks.addAll(downloadLinks);
	}

	public Set<BioagentsLink<DocumentationType>> getDocumentationLinks() {
		return documentationLinks;
	}
	public void addDocumentationLinks(List<BioagentsLink<DocumentationType>> documentationLinks) {
	...
	public Set<BioagentsLink<?>> getBrokenLinks() {
		return brokenLinks;
	}
